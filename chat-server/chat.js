...
const jwtVerifier = new OktaJwtVerifier({
  clientId: '0oa55nyqz7LbQQFaW5d7',
  issuer: 'https://dev-79032809.okta.com/oauth2/default',
});

const oktaClient = new okta.Client({
  orgUrl: 'https://dev-79032809.okta.com',
  token: '00IMiZUqo7nWAWc24j5IIXzPV1sAYmP8zEFTAMyle3',
});
